...
This is the detailed reasoning behind the cleanup in the main [README](../README.md). Useful for interview prep — each row is a decision I can explain the "why" behind.
...
| Downloads folder large | Needed manual review of contents | Left untouched rather than blind-deleting |
